          ...
          <div className="history-item">
            <div className="history-text">
              ...
              <p id="para1">
                ...
                ألوان النادي هي الأسود والأبيض، ويُلقب الفريق بلقلاق الشرق من قبل مناصريه.
          ...
          <div className="history-item reverse">
            <div className="history-text">
              ...
              <p id="para2">
                ...
                وبومدين بتموشنت بعد أن رأوا الطاقة الشبابية الغير محدودة من مواهب في حيهم "شارع الدار البيضاء".
